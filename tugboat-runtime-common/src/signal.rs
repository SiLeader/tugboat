...
pub fn create_signal_fifo(container_id: &str) -> Result<(), Error> {
...
pub fn start_signal_using_fifo(container_id: &str) -> Result<(), Error> {
...
pub fn wait_signal_using_fifo(container_id: &str) -> Result<(), Error> {
