...
#[utoipa::path(
        responses(
            (status = 200, description = "Resource created", body = Namespace),
...
#[utoipa::path(
        responses(
            (status = 200, description = "Resource deleted", body = Namespace),
...
#[utoipa::path(
        responses(
            (status = 200, description = "Resource details", body = Namespace),
            (status = 404, description = "Resource not found", body = StatusResponse),
            (status = 500, description = "Internal server error", body = StatusResponse),
        ),
        params(
